...
```{r}
df <- read.table("D:/active/moc/msc-phygeo-data-analysis/data/csv/AI001_gebiet_flaeche.csv",
...
```{r}
write.table(df, file = "D:/active/moc/msc-phygeo-data-analysis/temp/new.csv", 
            sep = ",", dec = ".")
```
