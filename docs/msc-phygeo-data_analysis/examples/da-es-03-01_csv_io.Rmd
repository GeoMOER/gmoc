...
```{r}
df <- read.table("C:/Users/tnauss/permanent/edu/gmoc_data/msc-phygeo-data-analysis/data/csv/AI001_gebiet_flaeche.csv",
...
```{r}
write.table(df, file = "C:/Users/tnauss/permanent/edu/gmoc_data/msc-phygeo-data-analysis/temp/new.csv", 
            sep = ",", dec = ".")
```
