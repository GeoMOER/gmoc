...
```
OK, if the place is one of "Landeshauptstadt", "Hansestadt" or "Universitätsstadt", then the third column contains the information "Kreisfreie Stadt". Hence, if we want to group by "Kreisfreie Stadt", we actually would need the third column. 
